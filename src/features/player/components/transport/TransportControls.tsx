// src/features/player/components/transport/TransportControls.tsx

import React from 'react';
import { Play, Square, SkipBack, Mic} from 'lucide-react';
import { usePlayback } from '../../hooks/usePlayback';
import { formatTime } from '../../utils/time.utils';
import { useAppDispatch, useAppSelector } from '../../hooks/useStore';
import { selectIsRecording, startRecording, stopRecording } from '../../state/slices/player.slice';
...
const TransportControls: React.FC = () => {
    ...
    const handleRecordToggle = () => {
        if (isRecording) {
            ...
            // Stop playback when stopping recording
            stop();
        } else {
            dispatch(startRecording());
            // Start playback when starting recording
            play();
        }
    };
    ...
    return (
        <div className="flex gap-2 mb-4 px-2 items-center">
            {/* Recording button - now fully functional */}
            <button
