// src/pages/studio/features/oscillators/store/middleware/index.ts
import { Middleware } from '@reduxjs/toolkit';
import { RootState } from '../../../../../../store';
import { setMode as setAudioMode } from '../oscillators.slice';
import keyboardAudioManager, { AdditiveOscillator } from '../../engine/synthesis/keyboardEngine.ts';
import { drumSoundManager } from '../../engine/synthesis/drumEngine.ts';
import {
    noteOn,
    noteOff,
    initializeAudio,
